...
##
# out1 = random.sample(range(len(data.edge_index[0])),256)
...
matrix = np.array(random.randint((1000),size=(256,256)))

eis = np.array(matrix[0],dtype=np.float32)
# eis = np.array(data.edge_index[0], dtype=np.float32)[out1]
...
# eid = np.array(data.edge_index[1], dtype=np.float32)[out1]
